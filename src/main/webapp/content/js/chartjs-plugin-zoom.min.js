...
!(function (e, t) {
  ...
  function h(e, { min: t, max: n }, o, a = !1) {
    ...
    return (
      (n += x),
      (t -= x) < m ? ((t = m), (n = Math.min(m + h, f))) : n > f && ((n = f), (t = Math.max(f - h, m))),
      (s.min = t),
      (s.max = n),
  ...
  const g = { second: 500, minute: 3e4, hour: 18e5, day: 432e5, week: 3024e5, month: 1296e6, quarter: 5184e6, year: 157248e5 };
  ...
  const v = {
    ...
    z = {
      category: function (e, t, n) {
        ...
        return (
          t < -r
            ? ((i = Math.min(i + s, o)), (a = 1 === c ? i : i - c), (l = i === o))
            : t > r && ((a = Math.max(0, a - s)), (i = 1 === c ? a : a + c), (l = 0 === a)),
          h(e, { min: a, max: i }, n) || l
        );
      },
      default: y,
  ...
  function k(e, t) {
    ...
    return (
      n.each(o, function (e) {
        ...
        })(e, a, i) && (a[e.id] = { min: { scale: e.min, options: e.options.min }, max: { scale: e.max, options: e.options.max } });
      }),
      M(a, o),
      M(i, o),
      a
  ...
  function V(e, t) {
    ...
    if (0 !== t.button || c(i(a), t) || r(i(s.drag), t)) return n.callback(s.onZoomRejected, [{ chart: e, event: t }]);
  ...
  function W(e, t) {
    return function (o, a) {
      ...
      return (
        !u ||
        !(!t.panning && 'mouse' === a.pointerType && (r(i(s), u) || c(i(l.drag), u))) ||
  ...
  function B(e, t, n) {
    if (t.scale) {
      ...
      j(e, { x: r.x && s(l, 'x', e) ? i : 1, y: r.y && s(l, 'y', e) ? i : 1, focalPoint: { x: o.x - c.left, y: o.y - c.top } }),
        (t.scale = n.scale);
    }
  }
  function A(e, t, n) {
    const o = t.delta;
    o && ((t.panning = !0), Z(e, { x: n.deltaX - o.x, y: n.deltaY - o.y }, t.panScales), (t.delta = { x: n.deltaX, y: n.deltaY }));
  }
  const I = new WeakMap();
  function U(e, t) {
    const o = d(e),
      ...
      c &&
        ...
        s.on('panend', () =>
          (function (e, t) {
            (t.delta = null),
              t.panning &&
                ((t.panEndTimeout = setTimeout(() => (t.panning = !1), 500)), n.callback(t.options.pan.onPanComplete, [{ chart: e }]));
          })(e, o)
        )),
      I.set(e, s);
  }
  function G(e, t, n) {
    ...
    u.save(),
      ...
      u.fillRect(c, r, s, l),
      o.borderWidth > 0 &&
        ((u.lineWidth = o.borderWidth), (u.strokeStyle = o.borderColor || 'rgba(225,225,225)'), u.strokeRect(c, r, s, l)),
      u.restore();
  }
  var J = {
    id: 'zoom',
    ...
    start: function (e, t, o) {
      (d(e).options = o),
        ...
        (Object.prototype.hasOwnProperty.call(o.zoom, 'overScaleMode') || Object.prototype.hasOwnProperty.call(o.pan, 'overScaleMode')) &&
    ...
    beforeUpdate: function (e, t, n) {
      (d(e).options = n),
        (function (e, t) {
          ...
          o.enabled ? (E(e, n, 'wheel', X), q(e, 'onZoomComplete', i, 250)) : L(e, 'wheel'),
            a.enabled
